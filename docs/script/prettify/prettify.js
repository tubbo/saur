  ...
  (function () {
    function T(a) {
      function d(e) {
        ...
        return (b = w[a])
          ? b
          : "0" <= a && "7" >= a ? parseInt(e.substring(1), 8)
            : "u" === a || "x" === a ? parseInt(e.substring(2), 16)
              : e.charCodeAt(1);
      }
      function f(e) {
      ...
      function b(e) {
        var b = e.substring(1, e.length - 1).match(
      ...
      function v(e) {
        ...
        if (e.ignoreCase && n) {
          for (g = 0; g < c; ++g) {
            k = a[g], e = k.charAt(0), 2 <= k.length && "[" === e
              ? a[g] = b(k)
              : "\\" !== e && (a[g] = k.replace(/[a-zA-Z]/g, function (a) {
                a = a.charCodeAt(0);
      ...
      function f(a) {
        for (
          ...
          if ("string" === typeof q) h = !1;
            ...
            !(h = 5 <= q.length && "lang-" === q.substring(0, 5)) || g &&
              "string" === typeof g[1] || (h = !1, q = "src");
            h || (r[z] = q);
          }
          k = p;
          p += z.length;
    ...
    function L(a, d, f) {
      ...
      function v(a) {
        function b(a, c) {
          var d = c ? a.cloneNode(!1) : a, k = a.parentNode;
          if (k) {
    ...
    t(
      y({ keywords: C, hashComments: !0, multiLineStrings: !0 }),
      ["bash", "bsh", "csh", "sh"],
    );
    t(
      y({
    ...
    t(
      y({ keywords: F, cStyleComments: !0, regexLiterals: !0 }),
          ...
          for (
            ...
            if (
              ...
              for (u = d.parentNode; u; u = u.parentNode) {
                if (
                  q.test(u.tagName) && u.className && r.test(u.className)
                ) {
                  n = !0;
                  break;
                }
              ...
              if (!n) {
                ...
                if (!n) {
                  var n = m.match(w), C;
                  !n && (C = V(d)) && z.test(C.tagName) &&
                    (n = C.className.match(w));
                  n && (n = n[1]);
                }
                if (y.test(d.tagName)) u = 1;
                else {
                  var u = d.currentStyle, x = v.defaultView, u = (u = u
                    ? u.whiteSpace
                    : x && x.getComputedStyle
                      ? x.getComputedStyle(d, null).getPropertyValue(
                        "white-space",
                      )
